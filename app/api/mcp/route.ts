...
"avatar": getZodTypeFromOpenApiSchema({"type":"string"}, z).optional(),
    ...
    server.tool("/api/v1/user/preferences", "EDIT USER PREFERENCES", z.object({"preferences": getZodTypeFromOpenApiSchema({"type":"object","properties":{"gender":{"type":"string","nullable":true},"styles":{"type":"array","items":{"type":"string"}},"sizes":{"type":"array","items":{"type":"string"}},"states":{"type":"array","items":{"type":"string"}}},"required":["gender","styles","sizes"],"additionalProperties":false}, z),
}), 
      async (params) => {
        try {
          let apiPath = "/api/v1/user/preferences";
...
"preferences": getZodTypeFromOpenApiSchema({"type":"object","properties":{"gender":{"type":"string","nullable":true},"styles":{"type":"array","items":{"type":"string"}},"sizes":{"type":"array","items":{"type":"string"}},"states":{"type":"array","items":{"type":"string"}}},"required":["gender","styles","sizes"],"additionalProperties":false,"nullable":true}, z).optional(),
}), 
      async (params) => {
        try {
...
"related_fulfillments": getZodTypeFromOpenApiSchema({"type":"array","nullable":true}, z).optional(),
}), 
      async (params) => {
        try {
